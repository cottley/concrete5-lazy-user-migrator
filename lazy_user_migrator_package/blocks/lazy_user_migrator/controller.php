<?php
/**
 * Lazy User Migrator Controller File.
 *
 * @author   Joshua Koudys, Christopher Ottley <cottley@gmail.com>
 * @license  See attached license file
 */
namespace Concrete\Package\LazyUserMigratorPackage\Block\LazyUserMigrator;
...
class Controller extends BlockController
{
     ...
     * @var string
     */
    protected $btName = 'Lazy User Migrator';
     ...
     * @var string
     */
    protected $btDescription = 'Quick and simple way to export your concrete5 users from one site and import them into another.';
     ...
     * @var string
     */
    protected $btHandle = 'lazy_user_migrator';
     ...
     * @var string
     */
    protected $btTable = 'btLazyUserMigrator';
